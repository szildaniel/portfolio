...
const PortfolioProject = () => {
  const [ghLink, setGhLink] = useState("https://github.com/szildaniel/portfolio2020");
  const [liveLink, setLiveLink] = useState("https://github.com/szildaniel/portfolio2020");
